...
export const Route = createFileRoute("/bookings")({
  head: () => ({
    meta: [
      { title: "Bookings — Aurelia Residences CRM" },
      {
        name: "description",
        content:
          "Track held and confirmed unit reservations, confirm paperwork or release a unit back to available.",
      },
      { property: "og:title", content: "Bookings — Aurelia Residences CRM" },
      {
        property: "og:description",
        content: "Held and confirmed reservations with instant conflict handling.",
      },
    ],
  }),
