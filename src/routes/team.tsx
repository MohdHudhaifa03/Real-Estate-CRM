...
export const Route = createFileRoute("/team")({
  head: () => ({
    meta: [
      { title: "Team performance — Aurelia Residences CRM" },
      {
        name: "description",
        content: "Admin-only view of each sales consultant's pipeline, reservations and win rate.",
      },
      { property: "og:title", content: "Team performance — Aurelia Residences CRM" },
      {
        property: "og:description",
        content: "Per-agent pipeline value, reservations and win rate.",
      },
    ],
  }),
  component: TeamPage,
    ...
    return (
      <AppShell title="Team performance">
        <EmptyState
          ...
          action={
            <Button asChild>
              <Link to="/leads">Back to my leads</Link>
            </Button>
          }
        />
      </AppShell>
