...
export const Route = createFileRoute("/projects/$projectId")({
  head: () => ({
    meta: [
      { title: "Project detail — Aurelia Residences CRM" },
      {
        name: "description",
        content:
          "Unit availability, gallery and illustrated master site plan for an Aurelia development.",
      },
      { property: "og:title", content: "Project detail — Aurelia Residences CRM" },
      {
        property: "og:description",
        content: "Availability, gallery and site plan for an Aurelia development.",
      },
    ],
  }),
